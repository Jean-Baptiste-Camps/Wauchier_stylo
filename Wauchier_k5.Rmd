...
KrakenResults = replicateAnalysis(toKeep, "data/transkr_raw_char3grams.csv", "data/transkr_expanded_words.csv", "data/transkr_pos3-gr.csv", "data/transkr_lemmas.csv", functionWords, functionLemmas)

# 4. perform comparison
comp2 = compareReplications(RefcahList, KrakenResults, k = 5)

# 5. merge and output
round(cbind(comp1, comp2), 2)
```
