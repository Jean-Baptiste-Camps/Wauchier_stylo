...
toKeep = c(toKeep, "60_Ano_Leg-B_NA_NA_NA_Antechriste")
# Redo base results without Antechrist
RefcahListBis = replicateAnalysis(toKeep, "data/transkr_raw_char3grams.csv", "data/transkr_expanded_words.csv", "data/transkr_pos3-gr.csv", "data/transkr_lemmas.csv", functionWords, functionLemmas)
...
comp2 = compareReplications(RefcahListBis, KrakenResults, k = 5)

# 5. merge and output
out = round(cbind(comp1, comp2), 2)
